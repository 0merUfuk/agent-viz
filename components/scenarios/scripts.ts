...
export const SCENARIOS: Scenario[] = [
  {
    ...
    steps: [
      { nodeIds: ["reviewer"],                           durationMs: 6000,  label: "receive diff" },
      { nodeIds: ["doublecheck"],                        durationMs: 8000,  label: "read & cross-reference" },
      { nodeIds: ["reviewer", "doublecheck"], edgeIds: ["sa:doublecheck->reviewer"], durationMs: 15000, label: "build + parallel checks" },
      { nodeIds: ["reviewer"],                           durationMs: 4000,  label: "verdict" },
    ],
    timeline: [
      { at: 500,   kind: "handoff",  from: "manager",     to: "reviewer",    content: "Review PR #{pr} — portal button component" },
      ...
      { at: 12800, kind: "message",  from: "reviewer",                       content: "Found {n} usages · scope contained" },
      { at: 14800, kind: "tool",     from: "reviewer",    tool: "Bash",      target: "npm run build", content: "Verify build still passes" },
      { at: 19200, kind: "message",  from: "reviewer",                       content: "Build complete · {ms}s" },
      ...
      { at: 24800, kind: "message",  from: "doublecheck",                    content: "input validation ✓" },
      { at: 26600, kind: "message",  from: "doublecheck",                    content: "disabled-state handling ✓" },
      { at: 28400, kind: "message",  from: "doublecheck",                    content: "keyboard navigation verified ✓" },
      { at: 30200, kind: "message",  from: "doublecheck",                    content: "error recovery ✓" },
      { at: 32500, kind: "verdict",  from: "reviewer",    to: "manager",     verdict: "approved", content: "approved" },
    ],
  },
  {
    id: "s2-strategy",
    ...
    steps: [
      ...
      { nodeIds: ["strategy-monthly"],                   durationMs: 15000, label: "synthesize report" },
    ],
    timeline: [
      ...
      { at: 24500,  kind: "message",  from: "product-lead",                                     content: "Pivot criterion hit on Stream 3 — {n} priority shifts queued" },
      { at: 26500,  kind: "message",  from: "tech-lead",                                        content: "Coverage {pct}% · {n} deps flagged" },
      { at: 28500,  kind: "message",  from: "growth-lead",                                      content: "Retention +{pct}% · channel B lagging" },

      { at: 31000,  kind: "handoff",  from: "product-lead",      to: "strategy-monthly",       content: "Assessment complete · {n} findings" },
      { at: 32200,  kind: "handoff",  from: "tech-lead",         to: "strategy-monthly",       content: "Assessment complete · {n} findings" },
      { at: 33400,  kind: "handoff",  from: "growth-lead",       to: "strategy-monthly",       content: "Assessment complete · {n} findings" },
      ...
      { at: 41500,  kind: "message",  from: "strategy-monthly",                                 content: "{n} priority shifts · {n} pivot triggers · {n} kill criteria" },

      { at: 44500,  kind: "verdict",  from: "strategy-monthly",  to: "manager",                verdict: "approved", content: "report synthesized · {n} priority shifts queued" },
    ],
  },
  {
    id: "s3-pipeline",
    ...
    steps: [
      ...
      { nodeIds: ["tester", "reviewer"], edgeIds: ["aa:manager->reviewer"],  durationMs: 7400, label: "review" },
      {
      ...
      { nodeIds: ["architect", "manager"],                                    durationMs: 6000, label: "merge" },
    ...
    timeline: [
      ...
      { at: 5500,   kind: "handoff",  from: "strategist",        to: "manager",                     content: "Brief drafted · {n} approaches · recommendation attached" },
      ...
      { at: 22600,  kind: "message",  from: "developer",                                             content: "Compiled in {ms}s" },
      ...
      { at: 38500,  kind: "handoff",  from: "manager",           to: "security-reviewer",           content: "ASI + OWASP scan on PR #{pr}" },
      ...
      { at: 43700,  kind: "message",  from: "security-reviewer",                                      content: "no injection surface · no new vulns" },
      ...
      { at: 53700,  kind: "verdict",  from: "manager",           to: "strategist",  verdict: "approved", content: "merged · PR #{pr}" },
    ],
  },
];
